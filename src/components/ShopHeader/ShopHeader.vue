      ...
      <div class="activity-sheet" v-show="showSupports">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="showSupports = false"></span>
          </div>
        </div>
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .shop-header
    ...
    .shop-brief-modal
      ...
      color #333
      &.fadeBulletin-enter-active, &.fadeBulletin-leave-active
        transition opacity .5s
      &.fadeBulletin-enter, &.fadeBulletin-leave-to
        opacity 0
      .brief-modal-cover
        position absolute
        width 100%
    ...
    .activity-sheet
      ...
      height 100%
      z-index 99
      &.fadeSupports-enter-active, &.fadeSupports-leave-active
        transition opacity .5s
      &.fadeSupports-enter, &.fadeSupports-leave-to
        opacity 0
