    ...
    <div class="loginInner">
      <div class="login_header">
        ...
        <div class="login_header_title">
          <a href="javascript:;" :class="{on : loginByMessage}" @click ="loginByMessage = true">
            短信登录
          </a>
          <a href="javascript:;" :class="{on : !loginByMessage}" @click = "loginByMessage = false">
            密码登录
          </a>
        </div>
      </div>
        ...
        <form>
          <div :class="{on : loginByMessage}">
            <section class="login_message">
              ...
              <button :disabled="!isRightNumber || computeTime > 0" class="get_verification"
                      :class="{right_phone_number : isRightNumber}"
                      @click.prevent="sendCode"
              >
                {{computeTime > 0 ? `已经发送(${computeTime})s` : `获取验证码`}}
              </button>
            </section>
