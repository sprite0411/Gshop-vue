  ...
  <div class="shop-info">
    <div class="info-content">
      <section class="section">
        ...
        <div class="delivery">
          <div>
            ...
            <span>由商家配送提供配送，约{{info.delieveryTime}}分钟送达，距离{{info.distance}}</span>
          </div>
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="supportType[support.type]" v-for="(support, index) in info.supports" :key="index">
