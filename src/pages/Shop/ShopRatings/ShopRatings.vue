...
<script>
    ...
    export default {
        ...
        data() {
          return {
              selectType: 0 , //0:点赞, 1:吐槽 , 2:全包含
              textOnly: true //true:只看有文本内容 , false:全看
          }
        },
        ...
        computed: {
          ...
          filterRatings() {
            ...
            return ratings.filter(rating => {
              ...
              //不勾选“仅文字评论” 或者 文字评论有值
              //textOnly === false || text.length > 0


              //同时成立
              return (selectType === 2 || selectType === rateType) && (textOnly === false || text.length > 0)
